...
export default function MechanicsLayout() {
  return (
    <Stack>
      ...
      <Stack.Screen name="atwood" options={{ headerShown: false }} />
      <Stack.Screen name="inclined-plane" options={{ headerShown: false }} />
      <Stack.Screen name="moment-balance" options={{ headerShown: false }} />
    </Stack>
  );
}
