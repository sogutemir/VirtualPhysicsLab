...
const ElectricFieldExperiment: React.FC = () => {
  ...
  return (
    <ExperimentLayout
      title={t('Elektrik Alanı Deneyi', 'Electric Field Experiment')}
      titleEn="Electric Field Experiment"
      ...
      descriptionEn="This experiment visualizes the electric field created by electric charges and the interactions between charges. Explore Coulomb's Law and the concept of electric fields."
      hideControls={true}
    >
      <ScrollView
